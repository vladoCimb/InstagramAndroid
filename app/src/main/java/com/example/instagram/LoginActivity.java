        ...
        login.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(str_email) || TextUtils.isEmpty(str_email)){
                    Toast.makeText(LoginActivity.this, "All fields are requered!", Toast.LENGTH_SHORT).show();
                }else{
                            ...
                            if(task.isSuccessful()){
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        pd.dismiss(); // TODO: 20/03/2019 hore som ju deklaroval ako final lebo to pindalo
